    ...
    <div className="min-h-[calc(100vh-10rem)] py-8 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
          <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mb-4">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M12 6.253v11.494m0 0A7.5 7.5 0 0019.5 12H4.5c0-1.03.194-2.006.55-2.892A7.514 7.514 0 0112 6.253z"
              ></path>
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <p className="text-slate-500 mb-4 text-sm">
            Discover new favorites from our growing collection.
          </p>
          <Link
            href="/recipes"
